...
import travelBag from '../../assets/bag.png'
      ...
      <div className='min-h-[550px] flex justify-center items-center backdrop-blur-xl py-12 sm:py-0'>
        <div className='container'>
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
            {/* image section */}
            <div>
              <img data-aos='flip-up' src={travelBag} alt="" className='max-w-[450px] h-[350px] w-full mx-auto drop-shadow-[5px_5px_12px_rgba(0,0,0,0.7)] object-cover' />
            </div>
            ...
            <div>
              ...
              <p data-aos='fade-up' className='text-sm text-gray-500 tracking-wide leading-8'>
                ...
                eget lacus in purus tincidunt maximus. Sed eget lacus in purus
                tincidunt maximus{''}
              </p>
